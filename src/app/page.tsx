...
const trustBlocks = [
  { label: "Safe Baby Materials", icon: ShieldCheck },
      ...
      <main>
        <section className="relative min-h-[calc(100vh-5rem)] overflow-hidden bg-sky-50">
          ...
          <div>
            ...
            <h1 className="mt-6 max-w-3xl text-5xl font-black leading-[1.02] tracking-normal text-slate-950 md:text-7xl">
              Baby care essentials for modern parents.
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
              Discover soft diapers, BPA-free feeding bottles, sippers, teethers, and care products selected for
              comfort, safety, and everyday Kenyan family life.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-lg soft-card">
              ...
              <div className="absolute bottom-4 left-4 right-4 rounded-lg bg-white/90 p-4 shadow-lg backdrop-blur">
                ...
                />
                <p className="mt-2 text-sm font-medium text-slate-600">Safe. Soft. Parent-approved.</p>
              </div>
            </div>
          </div>
          </div>
        ...
        <section id="shop" className="container-shell py-16">
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-black text-slate-950 md:text-4xl">Find the perfect picks for every kid.</h2>
            </div>
            <Link href="/category/baby-diaper" className="font-black text-brand-dark hover:underline">
              Browse all products
            </Link>
          </div>
        ...
        <section className="bg-sky-50/70 py-16">
          <div className="container-shell">
            ...
            <h2 className="mt-2 text-3xl font-black text-slate-950 md:text-4xl">Parent favorites ready for checkout.</h2>
            {homeOffer ? (
        ...
        <section className="container-shell grid gap-8 py-16 lg:grid-cols-[0.85fr_1.15fr]">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-black text-slate-950 md:text-4xl">Thoughtful quality for your little one.</h2>
            <p className="mt-4 leading-7 text-slate-600">
              At Me & Mommy, every product is crafted with care and precision to ensure comfort, safety, and peace of
              mind. Our products use safe, non-toxic materials because your baby deserves nothing but the best.
            </p>
          </div>
            ...
            {["Ethics first", "Consumer-centric", "Sustainability", "Innovation"].map((value) => (
              <div key={value} className="rounded-lg soft-card p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Built into product choices, communication, and the shopping experience.
                </p>
              </div>
            ))}
          </div>
